      ...
      <div className="mt-28 text-white px-4 " id="secao1">
         ...
         <div className="flex mt-20 justify-between max-md:flex-wrap-reverse max-md:justify-center">
            <div className="w-about-text text-justify max-md:mt-4">
               <p className="mb-5">
                  Olá, meu nome é <strong>Wendel</strong>, sou um entusiasta da
                  área de Sistemas de Informação e atualmente estou cursando o{" "}
                  <strong>
               ...
               <p className="mb-5">
                  Ao longo da minha jornada acadêmica, venho desenvolvendo um
                  forte interesse na área da <strong>web</strong> e me dedico
                  constantemente ao aprimoramento nesse campo, através de{" "}
                  <strong>cursos, projetos pessoais e monitoria na área</strong>
                  . Tenho grande afinidade com tecnologias como{" "}
                  <strong>
                     React, Typescript, Next e outras ferramentas para
                     desenvolvimento web
                  </strong>
                  . Além disso, possuo conhecimento básico em{" "}
                  <strong>NodeJs e Django</strong> para desenvolvimento de
                  back-end.
               </p>
               ...
               <p className="mb-5">
                  ...
                  características que acredito serem fundamentais para agregar
                  valor em qualquer ambiente de trabalho. Além disso, sou uma
                  pessoa pontual e sempre comprometida em superar desafios e
               ...
               <p className="mb-9">
                  ...
                  empresas que compartilham dos mesmos interesses e valores.
                  Vamos juntos em busca do crescimento e sucesso mútuo!
               </p>
            ...
            <div className="w-about-text flex flex-col items-center ml-3">
               <div className="relative w-min-content before:h-1 before:absolute before:bottom-[-28px] before:right-0 before:origin-left before:w-full before:left-0 before:bg-color-tertiary before:rounded-2xl mb-6">
                  <img src={imgPerfil} alt="Minha foto" className="w-80" />
               </div>
